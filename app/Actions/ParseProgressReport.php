...
class ParseProgressReport
{
    /**
     * @return array{
     *     date: string,
     *     entries: array<int, array{type: string, prdItems: array<string>, title: string, changes: array<string>, nextSteps: string|null}>,
     *     summary: array{total: int, implemented: int, fixed: int, verified: int}
     * }
     */
    ...
    /**
     * @return array{type: string, prdItems: array<string>, title: string, changes: array<string>, nextSteps: string|null}|null
     */

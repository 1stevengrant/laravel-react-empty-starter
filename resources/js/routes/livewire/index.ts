...
* @route '/livewire-8f8fd25a/upload-file'
*/
...
uploadFile.definition = {
    methods: ["post"],
    url: '/livewire-8f8fd25a/upload-file',
...
* @route '/livewire-8f8fd25a/preview-file/{filename}'
*/
...
previewFile.definition = {
    methods: ["get","head"],
    url: '/livewire-8f8fd25a/preview-file/{filename}',
